...
function Sizereference({setDisplay}) {
    const handleCloseSize = () => {
        setDisplay(0);
    }
    let modal = useRef(null);
    const handleEscape = (e) => {
        if (modal.current && !modal.current.contains(e.target)){//if (modal.current) để kiểm tra trong th này lỡ có sai
            setDisplay(0);
        }
    } 
    useEffect(() =>{
        window.addEventListener("click", handleEscape);
        return () => {
                    ...
                    <tr>
                        <td rowSpan="16" style={{"width": "250px"}}>
                            <div className="img_decription">
                                <img src="https://ivymoda.com/assets/files/news/2017/07/21/7862a565a9224a59871f26feca1864d0.png" alt =""/>
                            </div>
                        </td>
