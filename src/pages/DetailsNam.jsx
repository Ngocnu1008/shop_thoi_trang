  ...
  useEffect(() => {
    ...
    switch (type) {
      ...
      case "jeans":
        ...
        break;
      case "long_trousers":
        var details = long_trousers.filter(
          (value) => value.id === parseInt(id_sanpham)
        );
        setData(details);
        setRelate(
          long_trousers.filter((value) => value.id !== parseInt(id_sanpham))
        );
        break;
      case "short":
      ...
      case "shoes":
        ...
        break;
      case "accessory":
        var details = accessory.filter(
          (value) => value.id === parseInt(id_sanpham)
        );
        setData(details);
        setRelate(
          accessory.filter((value) => value.id !== parseInt(id_sanpham))
        );
        break;
      default:
        var details = news2.filter(
          (value) => value.id === parseInt(id_sanpham)
        );
        setData(details);
            ...
            <Right>
              ...
              <div className="nav_content">
                {display === 0 ? (
                  ...
                  <SizeReferenceGeneral setDisplay={setDisplay} />
                )}
              </div>
            </Right>
          </Wrap>
